...
namespace ReviewSite.Models
{
    public class Review
    {
        ...
        [MinLength(1), MaxLength(50), Display(Name = "Title")]
        ...
        [MinLength(2), MaxLength(20), Display(Name = "Author")]
        ...
        [Display(Name = "Published", Description = "Month/Day/Year format")]
        ...
        //For storage purposes, MaxLength is set to 1000 characters.  On a normal site, would be MUCH longer and include an option
